...
test("chat browse_web emits real SDK tool events and returns observed source content immediately", async (t) => {
  ...
  assert.match(requests[0].body, /browse_web to read one known public page/);
