...
An airy canvas, distinct gray and sky-blue message bubbles, large touch targets, rounded input and navigation pills, and restrained artifact frames keep attention on the work. Email, browser and PDF previews show actual tool results. The mascot is Regi, a tricolor corgi drawn from pre-rendered clips (apps/mobile/src/mascot).
